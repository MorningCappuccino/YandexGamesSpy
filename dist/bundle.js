...
function YandexGamesSpy(config) {
    ...
    function ColorWrapperByPlayersCount(wrapper, playersCount) {
    ...
    function renderGameInfo(el, game) {
        ...
        if (config.colorsBy == types_1.ColorsBy.DatePublished) {
            ...
            ColorWrapperByPlayersCount(wrapper, game.playersCount);
        }
        ...
        playersCountVSdaysOfPublished.innerHTML =
            "<span class='egs-label'>Players/Days </span>" + PlayersVSDaysPublished(game.playersCount, firstPublishedMs);
