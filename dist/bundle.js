                ...
                document.querySelectorAll(".game-card__game-url").forEach(function (el) {
                    if (+el.getAttribute("href").match(/\d+/)[0] == game.appID) {
                        ...
                        firstPublished.innerHTML =
                            "Release: " + moment(game.firstPublished).format("ll");
