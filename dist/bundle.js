...
hello("TypeScript");
(0, ygspy_1.YandexGamesSpy)();

},{"./ygspy":4}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function renderGameInfo(el, game) {
        ...
        playersEl.innerHTML =
            "<span class='egs-label'>Players </span>" +
                (0, numBeautifier_1.numBeautifier)(game.playersCount);
