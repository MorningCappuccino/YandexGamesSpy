...
var ygspy_1 = require("./ygspy");
var types_1 = require("./types");
// function hello(compiler: string) {
//   console.log(`Hello from ${compiler}`);
// }
// hello("TypeScript");
(0, ygspy_1.YandexGamesSpy)({ colorsBy: types_1.ColorsBy.PlayersCount });

},{"./types":4,"./ygspy":5}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.getRidOfDuplicates = exports.numBeautifier = void 0;
/*
 ** Example: 36550 -> 36 550
 */
function numBeautifier(num) {
    var modNum = "";
    var count = 0;
    num
        .toString()
...
exports.numBeautifier = numBeautifier;
/*
 ** Example: [1, 5, 2, 1] -> [1, 5, 2]
 */
var getRidOfDuplicates = function (arry) {
    return arry.filter(function (item, index) { return arry.indexOf(item) === index; });
};
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.ColorsBy = void 0;
var ColorsBy;
(function (ColorsBy) {
    ColorsBy[ColorsBy["DatePublished"] = 0] = "DatePublished";
    ColorsBy[ColorsBy["PlayersCount"] = 1] = "PlayersCount";
})(ColorsBy || (exports.ColorsBy = ColorsBy = {}));
...
var numBeautifier_1 = require("./numBeautifier");
var types_1 = require("./types");
var ygspyUtils_1 = require("./ygspyUtils");
function YandexGamesSpy(config) {
    var appIDs = [];
    ...
    appIDs = (0, numBeautifier_1.getRidOfDuplicates)(appIDs);
    console.log(appIDs);
    function getLocale() {
        var res = "ru";
        var hostDomain = location.host.match(/\.(\w+)/)[1];
        switch (hostDomain) {
            case "com":
                res = "en";
                break;
    ...
    function getGamesInfo() {
        return __awaiter(this, void 0, void 0, function () {
            var _a, locale, hostDomain, gameInfoUrl, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = getLocale(), locale = _a[0], hostDomain = _a[1];
                        gameInfoUrl = "https://yandex.".concat(hostDomain, "/games/api/catalogue/v2/get_games?lang=").concat(locale, "&draft=false");
    ...
    function ColorWrapperByPublishedDate(wrapper, datePublished) {
        var monthPassed = moment().diff(datePublished, "month");
        var daysPassed = moment().diff(datePublished, "days");
        if (monthPassed < 12) {
    ...
    function ColorWrapperByPlayersCount(wrapper, playersCount, playersVsDays) {
        var rank1 = (0, ygspyUtils_1.GetPlayersCountRank)(playersCount);
        var rank2 = (0, ygspyUtils_1.GetPlayersVsDaysRank)(playersVsDays);
        var colorCSSVar = (0, ygspyUtils_1.CompareRanks)(rank1, rank2);
        wrapper.style.background = "var(".concat(colorCSSVar, ")");
    }
    function PlayersVSDaysPublished(playersCount, datePublished) {
        var daysPassed = moment().diff(datePublished, "days");
        return Math.ceil(playersCount / daysPassed);
    }
    function GetDaysPassedBeautify(datePublished) {
        return moment(moment(datePublished), "YYYYMMDD").fromNow();
    }
    function renderGameInfo(el, game) {
        ...
        var playersCountVSdaysOfPublished = document.createElement("div");
        var firstPublishedMs = game.firstPublished * 1000;
        ...
        var playersVsDays = PlayersVSDaysPublished(game.playersCount, firstPublishedMs);
        playersEl.innerHTML = "<span class='egs-label'>Players </span>" + (0, numBeautifier_1.numBeautifier)(game.playersCount);
        firstPublished.innerHTML = "<span class='egs-label'>Release </span>" + moment(firstPublishedMs).format("ll");
        lifeSpan.innerHTML = " (".concat(GetDaysPassedBeautify(firstPublishedMs), ")");
        ...
        if (config.colorsBy == types_1.ColorsBy.DatePublished) {
            ColorWrapperByPublishedDate(wrapper, firstPublishedMs);
        }
        else if (config.colorsBy == types_1.ColorsBy.PlayersCount) {
...
},{"./numBeautifier":3,"./types":4,"./ygspyUtils":6,"moment":1}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.CompareRanks = exports.GetPlayersVsDaysRank = exports.GetPlayersCountRank = void 0;
var playersCountRankTable = [
    { 1: [0, 25000] },
    { 2: [25000, 50000] },
    { 3: [50000, 100000] },
    { 4: [100000, 200000] },
...
var playersVsDaysPublishedTable = [
    { 1: [0, 500] },
    { 2: [500, 1000] },
    { 3: [1000, 2000] },
    { 4: [2000, 5000] },
...
function GetPlayersCountRank(playersCount) {
    var rankRes = 1;
    // TODO: fix type any
    playersCountRankTable.forEach(function (rank, index) {
        var _a = rank[index + 1], min = _a[0], max = _a[1];
...
exports.GetPlayersCountRank = GetPlayersCountRank;
function GetPlayersVsDaysRank(playersVsDays) {
    var rankRes = 1;
    // TODO: fix type any
    playersVsDaysPublishedTable.forEach(function (rank, index) {
        var _a = rank[index + 1], min = _a[0], max = _a[1];
